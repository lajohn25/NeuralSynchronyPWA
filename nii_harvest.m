...
% LISA'S NEURAL ENTRAINMENT ONLY
%outDir = '/Users/lj4/Documents/projects/NeuralEntrainment/allscans/readytoprocess/output'; 
%baseDir = '/Users/lj4/Documents/projects/NeuralEntrainment/allscans/Archive_aphasia_NEEDSCANS'; %where all my subjex are stored


% LISA'S SPEECH ENTRAINMENT FC ONLY
outDir = '/Volumes/LJBIGBOY/CURRENT_COMP/projects/SpeechEntrainment/newcontrols/scans/OUTPUT_3.5.21'; 
baseDir = '/Volumes/LJBIGBOY/CURRENT_COMP/projects/SpeechEntrainment/newcontrols/scans/myfiles'; %where all my subjex are stored
...
modalityKeysVerbose = {'Lesion', 'T1', 'T2', 'DTI_',  'DTIrev', 'ASL', 'Rest_', 'fmrimirr'}; %DTIREV before DTI!!! both "DTIREV.nii" and "DTI.nii" have prefix "DTI"
%LJ SE change below
%modalityKeysVerbose = {'LESION', 'T1', 'T2', 'fmrimirr'}; %DTIREV before DTI!!! both "DTIREV.nii" and "DTI.nii" have prefix "DTI"

%for LJ SE


modalityDependency = [0, 1, 1,  0, 4, 0, 0, 0]; %T1 and T2 must be from same study as lesion
%modalityDependency = [0, 1, 1,  0]; %T1 and T2 must be from same study as lesion

modalityKeys = strrep(modalityKeysVerbose,'mirr',''); %LJ for SE
modalityKeys = strrep(modalityKeys,'_',''); 

%modalityKeys = strrep('','_',modalityKeysVerbose); 
xperimentKeys = {'SE', 'NE', 'POLAR', 'LIME', 'CT', 'R01', 'CAT'}; %order specifies priority: 1st item checked first!
